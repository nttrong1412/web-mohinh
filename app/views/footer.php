  <footer>
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           ...
                           <li><a target="_blank" href="#" class="fb"><img height="35" width="35" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                           <li><a target="_blank" href="#" class="fb"><img height="35" width="35" src="<?php echo BASE_URL ?>/public/images/tw.png">Twitter</a></li>
                           <li><a target="_blank" href="#" class="fb"><img height="32" width="32" src="<?php echo BASE_URL ?>/public/images/inta.jpg">Instagram</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline: 0949-213-792 </span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  nttrong1412@gmail.com</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  http://trongml11.com/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <div class="clear"></div>
         <div class="copyright">
            <h4 class="tkw9999">&copy;  © Bản quyền thuộc về Nguyễn Thế Trọng </h4>
         </div>
      </footer>
