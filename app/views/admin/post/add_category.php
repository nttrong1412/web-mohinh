...
<style type="text/css">
	input{
		display: block;width: 400px;height: 40px;border-radius: 10px;border-color: black; margin-bottom: 20px; margin-top: 20px;font-size: 20px;font-weight: normal;text-align: center;margin: auto;
	}
	label{
		font-size: 20px;
